...
.data
	;szCaption db 'Hello donotdont!', 0
...
.code
	start:
		;invoke MessageBox, NULL, OFFSET szText, OFFSET szCaption, MB_ICONEXCLAMATION or MB_YESNOCANCEL
	...
	WinMain proc hInst:DWORD, hPrevInst:DWORD, CmdLine:DWORD, CmdShow:DWORD
		...
		;invoke CreateWindowEx, WS_EX_LEFT or WS_EX_ACCEPTFILES, ADDR ClassName, ADDR AppName, \
	...
	WndProc proc hWnd:DWORD, uMsg:DWORD, wParam:DWORD, lParam:DWORD
		...
		.if uMsg == WM_CREATE
			...
			mov mdicreate.ly,CW_USEDEFAULT
				...
				invoke SendMessage,hwndClient,EM_SETTYPOGRAPHYOPTIONS,TO_SIMPLELINEBREAK,TO_SIMPLELINEBREAK
				invoke SendMessage,hwndClient,EM_GETTYPOGRAPHYOPTIONS,1,1
				...
				.else
					...
					invoke SendMessage,hwndClient,EM_SETEDITSTYLE,SES_EMULATESYSEDIT,SES_EMULATESYSEDIT
				.endif
				;=======================================================
				...
				invoke SendMessage, hwndClient, EM_LIMITTEXT, -1, 0
				;=============================================================
				; Set the default text/background color
				;=============================================================
				invoke SetColor
				;invoke SendMessage, hwndRichEdit, EM_SETMODIFY, FALSE, 0
				invoke SendMessage, hwndClient, EM_SETMODIFY, FALSE, 0
				;============================================================
				; set event mask
				;============================================================
				;invoke SendMessage, hwndRichEdit, EM_SETEVENTMASK, 0, ENM_MOUSEEVENTS
				;invoke SendMessage, hwndRichEdit, EM_EMPTYUNDOBUFFER, 0, 0
				invoke SendMessage, hwndClient, EM_SETEVENTMASK, 0, ENM_MOUSEEVENTS
				invoke SendMessage, hwndClient, EM_EMPTYUNDOBUFFER, 0, 0
		...
		.elseif uMsg == WM_COMMAND
			.if lParam == 0				; menu commands
				...
				.elseif ax == IDM_SAVE
					...
					.if eax != INVALID_HANDLE_VALUE
						@@:
							...
							invoke SendMessage, hwndClient, EM_STREAMOUT, SF_TEXT, ADDR editstream
							;==========================================================
							; Initialize the modify state to FALSE
							;==========================================================
							;invoke SendMessage, hwndRichEdit, EM_SETMODIFY, FALSE, 0
				...
				.elseif ax==IDM_FINDNEXT
					...
					.if eax!=0
						;invoke SendMessage,hwndRichEdit,EM_EXGETSEL,0,addr findtext.chrg
						invoke SendMessage,hwndClient,EM_EXGETSEL,0,addr findtext.chrg
						mov eax,findtext.chrg.cpMin
						.if eax!=findtext.chrg.cpMax
							push findtext.chrg.cpMax
							pop findtext.chrg.cpMin
						...
						mov findtext.lpstrText,OFFSET FindBuffer
						;invoke SendMessage,hwndRichEdit,EM_FINDTEXTEX,FR_DOWN,addr findtext
						invoke SendMessage,hwndClient,EM_FINDTEXTEX,FR_DOWN,addr findtext
						.if eax!=-1
							;invoke SendMessage,hwndRichEdit,EM_EXSETSEL,0,addr findtext.chrgText
							invoke SendMessage,hwndClient,EM_EXSETSEL,0,addr findtext.chrgText
						.endif
					.endif
				.elseif ax==IDM_FINDPREV
					...
					.if eax!=0
						...
						invoke SendMessage,hwndClient,EM_FINDTEXTEX,0,addr findtext
						.if eax!=-1
							;invoke SendMessage,hwndRichEdit,EM_EXSETSEL,0,addr findtext.chrgText
							invoke SendMessage,hwndClient,EM_EXSETSEL,0,addr findtext.chrgText
						.endif
		...
		.elseif uMsg == WM_SIZE
			...
			invoke MoveWindow, hwndClient, 0, 0, eax, edx, TRUE
